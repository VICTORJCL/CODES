...
# # Obter os valores da linha 4 para usar como cabeçalhos de coluna
# novos_cabecalhos = db_sheet2.iloc[4].values

# # Definir os novos cabeçalhos e remover a linha 4 e anteriores
# db_sheet2.columns = novos_cabecalhos
# db_sheet2 = db_sheet2.iloc[5:].reset_index(drop=True)
